...
/*
  ...
  The -o flag is used by the testing script.  It causes the results of your ray
  tracer to be printed to a file rather than to the standard output.  This
  prevents the testing script from getting confused by debugging output.
...
int main(int argc, char** argv)
{
    ...
    Dump_png(world.camera.colors,width,height,"output/output.png");
    ...
    if(solution_file)
    {
        ...
        Dump_png(data_sol,width,height,"output/diff.png");
        delete [] data_sol;
    }
